...
class CommandeRepository extends ServiceEntityRepository
{
    ...
    public function saveitem(Commandes $entity, bool $flush = false): void
...
//    }
    ...
    public function findCartItemsWithProductInfo($idCommande)
    {
        $qb = $this->createQueryBuilder('c');
        $qb->select('p.nomProduit', 'p.imagePath')
           ->join('c.idProduit', 'p')
           ->where('c.id = :cartId')
           ->setParameter('cartId', $idCommande);
